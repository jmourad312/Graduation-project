                    ...
                    <article className="card card--1">
                        <div className="card__info-hover">
                            <div className="card__clock-info">
                                ...
                                </svg><span className="card__time">{props.date}</span>
                            </div>

                        </div>
                        <div className="card__img" style={{ background: `url(${props.imgSrc})` }}></div>
                        <p className="card_link">
                            <div className="card__img--hover" style={{ background: `url(${props.imgSrc})` }} ></div>
                        </p>
                        <div className="card__info">
                            <h3 className="card__title text-truncate">{props.cardTitle}</h3>
                            <span className="card__by">by <span className="card__author" title="author">{props.userName}</span></span>
                            <br />
                            <small>
