...
export default function Admin(props) {
    ...
    const banneduser = async (parameter) => {
        try {
            if (parameter.banned == false) {
                const res = await instance.post("admin/addUserBan", { id: parameter.person._id },
                    { headers: { Authorization: localStorage.getItem("Authorization") } });
                console.log(res);
            }
            else {
                const res = await instance.post("admin/removeUserBan", { id: parameter.person._id },
                    { headers: { Authorization: localStorage.getItem("Authorization") } });
                console.log(res);
            }
    ...
    const bannedvendor = async (parameter) => {
        try {
            if (parameter.banned == false) {
                const res = await instance.post("admin/addVendorBan", { id: parameter.person._id },
                    { headers: { Authorization: localStorage.getItem("Authorization") } });
                console.log(res);
            }
            else {
                const res = await instance.post("admin/removeVendorBan", { id: parameter.person._id },
                    { headers: { Authorization: localStorage.getItem("Authorization") } });
                console.log(res);
            }
